...
# En förbättring av delen som dupplicerade 
...
#---------------------------------------------------------------------------------
    # Jag ändrade den tidigare valideringen för att få ett tydligare 
    #  felmeddelande när obligatoriska kolumner saknas. 
    # På så sätt kan man direkt se exakt vilka kolumner som saknas, 
    #  vilket gör det enklare att upptäcka och åtgärda fel i datan. 
